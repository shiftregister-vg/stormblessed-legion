...
<head>
    ...
    <!-- FAVICONS -->
    <link rel="shortcut icon" href="${resource(dir: 'admin/img', file: 'favicon.ico')}" type="image/x-icon">
    <link rel="icon" href="${resource(dir: 'admin/img', file: 'favicon.ico')}" type="image/x-icon">
    ...
    <link rel="apple-touch-icon" href="${resource(dir: 'admin/img', file: 'sptouch-icon-iphone.png')}">
    <link rel="apple-touch-icon" sizes="76x76" href="${resource(dir: 'admin/img', file: 'touch-icon-ipad.png')}">
    <link rel="apple-touch-icon" sizes="120x120" href="${resource(dir: 'admin/img', file: 'touch-icon-iphone-retina.png')}">
    <link rel="apple-touch-icon" sizes="152x152" href="${resource(dir: 'admin/img', file: 'touch-icon-ipad-retina.png')}">
